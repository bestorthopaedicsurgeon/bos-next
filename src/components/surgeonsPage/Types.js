...
const Types = () => {
  const cards = [
    ...
    },
    {
      ...
      title: "Spine Surgeon",
      description:
        "Spine surgeons treat issues affecting the back, neck, and spinal cord. They perform procedures like disc replacement, spinal fusions, and decompressions. Their expertise helps reduce back pain and improve spinal health.",
    },
    {
      icon: "/surgeons/types/2.png",
      title: "Pediatric Orthopaedic Surgeon",
      description:
        "This specialist focuses on treating bone, joint, and muscle conditions in children. They manage growth-related issues, congenital deformities, and pediatric fractures. Their care ensures development of a child’s musculoskeletal system.",
    },
    {
      icon: "/surgeons/types/3.png",
      title: "Orthopaedic Oncologist",
      description:
        "Orthopaedic oncologists diagnose and treat bone and soft tissue cancers. They handle complex surgeries to remove tumors while preserving limb function. Their work involves collaboration with cancer specialists for holistic care.",
    },
  ];
